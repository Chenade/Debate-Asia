                                    ...
                                    <div class="col-11 bg-dark" style="min-height: 80px; margin: 10px; padding: 1em; color: #FFFFFF;" data-id="${k}">
                                        ...
                                        <div class="d-flex justify-content-between flex-wrap">
                                            <div class="col-12 col-md-8">
                                                <h5 class="mb-0 mt-0" style="color: #FFFFFF;">${a.data[i].groups[j].sessions[k].session_name}｜場次編號：${l}</h5>
                                            ...
                                            <div class="col-12 col-md-4 d-flex align-items-center">
                                                <button class="btn btn-light mb-0 start-btn" data-session_id="${k}" data-room_number=${l}>查看評分</button>
                                            </div>
                                        </div>
                                    </div>
                                `);
