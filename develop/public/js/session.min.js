...
function updateUI(stage, data) {
    ...
    switch (config.status) {
        case 0:
            ...
            $('#videos').attr('src', 'https://player.youku.com/embed/XNTkzMzUwMTYyNA==');
...
function displaySessionInfo(data) {
    $('#tag').text(data.session.group_name);
    $('#title').empty();
    $('#title').append('<h4 class="mt-0 mb-1" style="text-indent: 1em;">正方：' + data.session.pos_title + '</h4>');
    $('#title').append('<h4 class="mt-0 mb-1" style="text-indent: 1em;">反方：' + data.session.neg_title + '</h4>');
