$(document).ready(function() {
    ...
    var sid = 0, stage = 0, role = null, lastUpdated = null, 
    ...
    }, updateSession = function(stage)
    {
        ...
        ajax('PUT', '/api/sessions/' + sid, data, function (a) {
            if(a.success){
                ...
                $.growl.notice({message: '已完成此階段，請靜候對手'})
                setSessionStatus();
            }else
                    ...
                    switch (a.data.status) {
                        ...
                        case 1:
                            ...
                            if (stage === a.data.status)
                            {
                                ...
                                diff = (moment(_now).diff(lastUpdated, 'minutes')) - 60;
                                $('#remainTime').text(40 - diff);
                                ...
                                mainTimer = setInterval(() => {
                                    ...
                                    const diff = (moment(_now).diff(lastUpdated, 'minutes')) - 60;
                        ...
                        case 4:
                            ...
                            setTimeout(() => {
                                window.location.href = "/candidate/" + mid;
                            }, 3000);
                    }
                }
                if (stage != a.data.status)
