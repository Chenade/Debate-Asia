...
switch (lang) {
    case 'cn':
        ...
        langDict['signup_error' ] = '账号已被注册或密码错误！';
        langDict['login_error'] = '账号或密码错误！';
    break;
    ...
    case 'zh':
        ...
        langDict['signup_error' ] = '帳號已被註冊或密碼錯誤！';
        langDict['login_error'] = '帳號或密碼錯誤！';
    break;
    ...
    case 'en':
        ...
        langDict['signup_error' ] = 'Account already taken or Wrong Password!';
        langDict['login_error'] = 'Account or Password is incorrect!';
    break;
...
function translate(input) {
    ...
    for (var i = 0 ; i < input.length ; i++)
    {
        switch (lang) {
            case 'cn':
                if (input.charCodeAt(i) > 10000 && tradition.indexOf(input.charAt(i)) != -1)
                    s += simple.charAt(tradition.indexOf(input.charAt(i)));
                else 
                    s += input.charAt(i);
            break;
        
            case 'zh':
                if (input.charCodeAt(i) > 10000 && simple.indexOf(input.charAt(i)) != -1)
                    s += tradition.charAt(simple.indexOf(input.charAt(i)));
                else 
                    s += input.charAt(i);
            break;
