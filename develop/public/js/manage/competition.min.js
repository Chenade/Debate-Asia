                        ...
                        <tr>
                            ...
                            <td>
                                <input 
                                    ...
                                    data-id="${_this.rounds[0].round_id}"
                                    value="${((_this.rounds[0].round_number) != null) ? _this.rounds[0].round_number : ''}">
                            </td>
                            <td>
                                <select class="form-control rounds-role" data-id="${_this.rounds[0].round_id}">
                            ...
                            <td>
                                <button class="btn btn-sm btn-danger rounds-remove-btn" data-id="${_this.rounds[0].round_id}">REMOVE</button>
                            </td>
                        </tr>
                    `);
                }
