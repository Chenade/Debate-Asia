...
$(document).ready(function () {
        ...
        columns: [
            ...
            { data: 'school_cn',
              render: function (data, type, row) {
                if (type === 'display') {
                    return (data === null) ? '' : (data.length > 5) ? data.substr(0, 5) + '...' : data;
                }
                return data;
                }
            },
    ...
    $('#competition-getLink-btn').click(function () {
        var competitionId = $('#competition_id').val();
        var url = window.location.origin + '/signup?code=' + competitionId;
        // copyToClipboard with url
